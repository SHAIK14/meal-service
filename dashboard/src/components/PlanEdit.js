...
const PlanEdit = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 overflow-y-auto h-screen  to-gray-100 p-4 md:p-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="p-6 md:p-8">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Edit Plan</h1>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      value={plan.service}
                      disabled
                      className="w-full bg-gray-100 text-gray-500 border border-gray-300 rounded-lg py-2 px-3 appearance-none focus:outline-none"
                    >
                    ...
                    <div className="flex items-center mt-2 text-xs text-amber-600">
                      ...
                      <span>
                        Service type cannot be modified after plan creation
                      </span>
                    </div>
                  </div>
                </div>
