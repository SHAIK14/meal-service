...
import 'C:/Users/USER/Desktop/Zafran/meal-service/dashboard/src/styles/Banners.css'; 
//import 'C:/Users/USER/Desktop/Zafran/meal-service/dashboard/src/styles/Banners.css'; // Assume the CSS is still in the same location
      ...
      <div className="banner-list">
        {banners.map((banner, index) => (
          <div key={index} className="banner-item">
            ...
            {banner ? (
              <img src={banner.url} alt={`Banner ${index + 1}`} className="banner-img" />
            ) : (
