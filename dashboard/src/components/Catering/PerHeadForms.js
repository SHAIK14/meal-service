...
const PerHeadForms = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Basic validation
    if (!packageName || !packagePrice || selectedCategories.length === 0) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 py-2 border border-gray-300 -md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        ...
        <div className="relative">
          ...
          {isCategoryDropdownOpen && (
            <div className="z-10 w-full mt-1 relative border border-gray-300 -md shadow-lg overflow-hidden">
              ...
              <div className="sticky top-0 z-20 bg-white p-2 border-b border-gray-200">
                <input
                  ...
                  className="w-full px-2 py-1 border border-gray-300 -md focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="max-h-[150px] overflow-y-auto">
                ...
                <div>
                  ...
                  {/* Add additional padding at bottom to ensure scrollable content doesn't hide behind the fixed button */}
        ...
        <div className="flex justify-between space-x-2">
          <button
            type="button"
            onClick={onClose}
            className="w-full bg-gray-200 text-gray-800 py-2  hover:bg-gray-300 transition-colors"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="w-full bg-gray-800 text-white py-2  hover:bg-gray-900 transition-colors"
          >
            Submit Package
          </button>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 -lg shadow-xl w-96">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 -md mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-500 text-white -md hover:bg-blue-600"
              >
                Save Category
              </button>
            </div>
