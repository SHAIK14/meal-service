...
export const updateCategoryOrder = async (updates) => {
  try {
    // Adjust this URL to match your actual API endpoint structure
    const response = await fetch("/api/dining-category/order", {
      method: "PUT",
      headers: {
